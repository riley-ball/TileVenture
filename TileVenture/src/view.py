...
class GameView(tk.Canvas):
    def __init__(self, master, *args, size, cell_size, **kwargs):
        ...
        # Misc
        self.lake0 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_416.png")
        self.lake1 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_417.png")
        self.lake2 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_418.png")
        self.lake3 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_436.png")
        self.lake4 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_392.png")
        self.lake5 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_435.png")
        self.lake6 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_437.png")
        self.lake7 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_438.png")
        self.lake8 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_439.png")

        self.misc0 = tk.PhotoImage(file="TileVenture/images/spritesheet/terrain/terrain_159.png")
